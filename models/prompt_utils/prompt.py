...
class CodaOnePrompt(nn.Module):
    ...
    def forward(self, x_querry, l, x_block, train=False):
        ...
        if l in self.e_layers:
            ...
            # A: 100, 8 / P: 100, 8, 192 -> out: 8, 192
            P_ = torch.einsum('lk,lkd->kd', A, p)
            P_ = P_.expand(len(x_querry),-1,-1) # B, 8, 192
...
class OSPrompt(nn.Module):
    ...
    def _init_smart(self, emb_d):
        ...
        # strenth of ortho penalty
        self.qr_loss_weight = self.args.qr_loss_weight
