"""
ToPrune Prompt Learning for On-Device Continual Learning
...
from models.patchdrop_prompt_utils.model import PromptModel
...
class PatchDropPrompt(ContinualModel):
    ...
    def get_parser(parser) -> ArgumentParser:
        ...
        parser.add_argument('--prompt_keep_rate', type=float, help='keep rate for patch dropout')
        parser.add_argument('--query_keep_rate', type=float, help='keep rate for patch dropout')
