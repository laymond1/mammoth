...
Note:
    Elastic-Prompt USES A CUSTOM BACKBONE: `vit_base_patch16_224`.
...
class StaticPrompt(ContinualModel):
    ...
    def get_parser(parser) -> ArgumentParser:
        ...
        parser.add_argument('--elastic_type', type=str, default='elastic_M', help='ElasticViT type in search space yaml file')
