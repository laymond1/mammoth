...
def main_prune_parse_arguments(parser):
    ...
    prune_retrain.add_argument('--sp-retrain', type=binary_to_boolean_type, default=True,
                               help="Retrain a pruned model")
    parser.add_argument('--sp-config-file', type=str,
                        help="define config file")
    parser.add_argument('--sp-no-harden', type=binary_to_boolean_type, default=False,
                        help="NOTE: This option is deprecated(Do not harden the pruned matrix)")
    parser.add_argument('--sp-admm-sparsity-type', type=str, default='irregular',
