"""
EViT Prompt Learning for On-Device Continual Learning
...
from models.evit_prompt_utils.model import PromptModel
from models.evit_prompt_utils.utils import adjust_keep_rate
...
class EViTPrompt(ContinualModel):
