...
from models.superprompt_utils.elasticvit.superformer import FusedSuperNet
from models.superprompt_utils.elasticvit.common_ops import BNSuper1d, LNSuper
...
def build_supernet(args):
    ...
    model = FusedSuperNet(args.input_size, args.super_stem_channels, args.dataloader.num_classes, args.search_space.stage,
                          ...
                          args.search_space.qk_scale, args.search_space.v_scale, args.head_type, args.classifer_head_dim, args.head_dropout_prob, args.pre_norm, norm_layer, args.search_space.res, args.search_space.downsampling, 
                          bank_flops_ranges, args.search_space.se, classifier_mul=classifier_mul, dw_downsampling=dw_downsampling, 
