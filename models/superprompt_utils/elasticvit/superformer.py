...
from models.superprompt_utils.elasticvit.cnn import SuperCNNLayer, conv_stem
from models.superprompt_utils.elasticvit.common_ops import BNSuper1d, BNSuper2d, LNSuper
from models.superprompt_utils.elasticvit.transformer import (ELinear, SuperAttention, SuperFFN,
                          SuperTransformerBlock)
from models.superprompt_utils.elasticvit.sample_utils import mutate_dims, softmax, parse_arch
...
class FusedSuperNet(nn.Module):
    def __init__(self, input_size, super_stem_channels, num_classes, stage, depth, conv_ratio, mlp_ratio, num_heads, min_depth,
                 ...
                 act=nn.Hardswish, classifier_mul=4, dw_downsampling=False, sample_prob=1, head_dims=8, use_res_specific_RPN=False, 
                 bank_size=150, bank_sampling_rate=0.5, bank_sampling_method='weighted_prob', flops_bound=15, flops_sampling_method='random', 
                 model_sampling_method='preference', big_bank_size=50, max_importance_comparision_num=5, use_latency=False, latency_bound=1.5, 
                 flops_tables={'min': []}
                 ):
        super().__init__()
