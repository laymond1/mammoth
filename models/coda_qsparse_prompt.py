"""
ToMe Prompt Learning for On-Device Continual Learning
...
from models.tome_prompt_utils.model_qsparse import PromptModel
...
class CodaQSparsePrompt(ContinualModel):
    ...
    def get_parser(parser) -> ArgumentParser:
        ...
        parser.add_argument('--prompt_query_sparse', type=binary_to_boolean_type, default=True, help='enable token merging during prompt forward pass for efficiency')
        parser.add_argument('--head_query_sparse', type=binary_to_boolean_type, default=False, help='enable token merging during head forward pass for efficiency')
        parser.add_argument('--test_query_sparse', type=binary_to_boolean_type, default=True, help='enable token merging during test forward pass for efficiency')
