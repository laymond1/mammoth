"""
Adaptive Token Sampler Prompt Learning for On-Device Continual Learning
...
from models.ats_prompt_utils.model import PromptModel
...
class ATSPrompt(ContinualModel):
    ...
    def get_parameters(self):
        return [p for n, p in self.net.named_parameters() if 'prompt' in n or 'head' in n or 'out_zero_mask' in n]
