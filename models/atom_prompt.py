"""
REP: Resource Efficient Prompt Learning for On-Device Continual Learning
...
from models.atom_prompt_utils.model import PromptModel
...
class AToMPrompt(ContinualModel):
    ...
    def get_parser(parser) -> ArgumentParser:
        ...
        parser.add_argument('--prompt_r', type=int, help='number of tokens to merge')
        parser.add_argument('--query_r', type=int, help='number of tokens to merge')
        # Prompt Sparsity
