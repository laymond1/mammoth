...
# CIL CONFIG
NAME="Online BFPrompt with module2 (upper-bound) and no E-Prompt"
NOTE="si-blurry-bfprompt-module2-upper-bound-no-E"  # Short description of the experiment.
...
for DATASET in "${DATASETS[@]}"; do
    ...
    for seed in 1; do
        ...
        --g_prompt_layer_idx $g_prompt_layer_idx --e_prompt_layer_idx 
    done
done
