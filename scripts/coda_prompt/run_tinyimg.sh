...
# CIL CONFIG
NOTE="si-blurry-coda-prompt"  # Short description of the experiment.
MODEL="online-coda-prompt"
SCENARIO="si-blurry"  # Mode configuration
DATASET="seq-tinyimg-224"  # Dataset options: cifar100, tinyimg, imagenet-r
N_TASKS=5
N=50
M=10
USE_AMP="--use_amp"
