...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    mng_group.add_argument('--savecheck', type=str, default='task', choices=['last', 'eval', 'task'], help='Save checkpoint every `task` or at the end of the training (`last`).')
...
def add_online_learning_args(parser: ArgumentParser) -> None:
    ...
    online_group.add_argument('--online_scenario', type=str, default='si-blurry', choices=[None, 'online-stand-cil', 'online-cil', 'si-blurry', 'periodic-gaussian'],
    ...
    online_group.add_argument('--rnd_NM', type=binary_to_boolean_type, default=True, 
