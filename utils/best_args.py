    ...
    'seq-cifar100': {
            ...
            'er': {500: {'lr': 0.1, 
                   ...
                   5120: {'lr': 0.1, 
                          ...
                          'n_epochs': 1}},
            'gdumb': {500:  {'lr': 0.1, 
                             'maxlr': 0.05, 'minlr': 5e-4, 
                             'cutmix_alpha': 1, 
                             'fitting_epochs': 250, 
                             'optim_mom': 0.9, 'optim_wd': 1e-6,
                             'n_epochs': 1},
                      2000: {'lr': 0.1, 
                             'maxlr': 0.05, 'minlr': 5e-4, 
                             'cutmix_alpha': 1, 
                             'fitting_epochs': 250, 
                             'optim_mom': 0, 'optim_wd': 1e-6,
                             'n_epochs': 1}},
            'lucir': {500: {'lr': 0.03, 'lr_finetune':0.01,  
                            'optim_mom': 0.9, 'optim_wd': 0, 
                            'lamda_base': 5, 
                            'k_mr':  2, 
                            'fitting_epochs': 20, 
                            'mr_margin': 0.5, 'lamda_mr': 1.,
                            'n_epochs': 1},
                      2000: {'lr': 0.03, 'lr_finetune':0.01,  
                             'optim_mom': 0.9, 'optim_wd': 0, 
                             'lamda_base': 5, 
                             'k_mr':  2, 
                             'fitting_epochs': 20, 
            ...
            'icarl': {500: {'lr': 0.3, 
                      ...
                      5120: {'lr': 0.3, 
                             ...
                             'n_epochs': 1}},
            'bic': {500: {'lr': 0.03, 
                          'optim_mom': 0, 'optim_wd': 0,
                          'n_epochs': 1},
                    2000: {'lr': 0.03, 
                          'optim_mom': 0, 'optim_wd': 0,
                          'n_epochs': 1}},
            'lwf': {-1: {'lr': 0.03, 
                         'optim_mom': 0, 'optim_wd': 5e-4,
                         'n_epochs': 1}},
            'er_ace': {500: {'lr': 0.03, 
                             'optim_mom': 0, 'optim_wd': 0,
                             'n_epochs': 1},
            ...
            'xder': {500: {'m': 0.7, 
                           ...
                           'beta': 0.8, 
                           'gamma': 0.85, 
                           'optim_wd': 0, 'optim_mom': 0,
                           'lambd': 0.05, 
                           'eta': 0.001, 
                           'lr': 0.03, 
                           'simclr_temp': 5, 'simclr_batch_size':64, 'simclr_num_aug': 2,
                           'n_epochs': 1},
                     2000: {'m': 0.2, 
                           'alpha':0.6, 
                           'beta': 0.9, 
            ...
            'co2l': {500: {'lr': 0.1,
                     ...
                     2000: {'lr': 0.1,
                           ...
                           'warm':1, 'save_store':1,
                           'n_epochs': 1}},
            'vncr': {500: {'lr': 0.1, 'simclr_temp': 0.1, 'gamma': 0.5},
                     2000: {'lr': 0.1, 'simclr_temp': 0.1, 'gamma': 0.5}},
            'vencr': {500: {'lr': 0.1, 'simclr_temp': 0.1, 'gamma': 0.5},
                      2000: {'lr': 0.1, 'simclr_temp': 0.1, 'gamma': 0.5}}
            }
      }
}
